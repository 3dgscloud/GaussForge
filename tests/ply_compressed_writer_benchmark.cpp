...
// Compressed PLY write speed benchmark
static void BM_PlyCompressedWriter_Write(benchmark::State &state) {
...
// Register benchmark: Test write speed for different compressed PLY file sizes
// Using common point count ranges: 1K, 10K, 100K, 500K, 1M, 5M
BENCHMARK(BM_PlyCompressedWriter_Write)
    ->Arg(1000)    // 1K points
